...
# from lotus.lifelong.models.model_utils import safe_cuda
# from lotus.lifelong.models.conf_utils import *
# from lotus.lifelong.models.torch_utils import *


@hydra.main(config_path="../configs", config_name="mtact_config", version_base=None)
def main(hydra_cfg):
    # preprocessing
    ...
    ##TODO: baku policy training
    # cfg.skill_learning.num_subtasks = n_tasks
    with open(os.path.join(cfg.experiment_dir, "config.json"), "w") as f:
        json.dump(cfg, f, cls=NpEncoder, indent=4)


    algo = MTACTtask(n_tasks, cfg)
    #
    # if cfg.pretrain_model_path != "":
    #     baku_policy.load_model(task_id=-1, experiment_dir=cfg.pretrain_model_path)
    #
    algo.learn_multi_task(datasets, benchmark)
