...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["base", "er", "ewc", "packnet", "multitask", "moe", "mtact"],
    )
    parser.add_argument(
        "--policy",
        type=str,
        required=True,
        choices=["bc_rnn_policy", "bc_transformer_policy", "bc_transformer_moe_policy", "bc_vilt_policy", "mtact_policy"],
    )
...
def main(args):
    ...
    algo = safe_device(MTACTtask(10, cfg), cfg.device)
