...
from lotus.lifelong.algos import get_algo_class, get_algo_list, Multitask
    ...
    for i in range(n_manip_tasks):
        ...
        try:
            task_i_dataset, shape_meta = get_dataset(
                ...
                obs_modality=cfg.data.obs.modality,     # {"rgb": ["agentview_rgb","eye_in_hand_rgb"],"depth": [],"low_dim": ["gripper_states","joint_states"]}
